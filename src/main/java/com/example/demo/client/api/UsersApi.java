...
import com.example.demo.client.model.Manager;
...
import com.example.demo.client.model.Student;
import com.example.demo.client.model.Teacher;
import com.example.demo.client.model.TooManyRequestsException;
import com.example.demo.client.model.UpdateStudentCourse;
...
public class UsersApi {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<List<Student>>(
          ...
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<List<Student>>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<List<Teacher>>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<List<Teacher>>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<Manager>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<Manager>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<List<Manager>>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<List<Manager>>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<Student>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<Student>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getStudentsRequestBuilder(Integer page, Integer pageSize, String ref, String firstName, String lastName) throws ApiException {
    ...
    localVarQueryParameterBaseName = "page_size";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("page_size", pageSize));
    localVarQueryParameterBaseName = "ref";
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<Teacher>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<Teacher>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
