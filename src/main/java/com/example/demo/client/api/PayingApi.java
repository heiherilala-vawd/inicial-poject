...
import com.example.demo.client.model.CreateDelayPenaltyChange;
import com.example.demo.client.model.CreateFee;
import com.example.demo.client.model.CreatePayment;
import com.example.demo.client.model.DelayPenalty;
import com.example.demo.client.model.Fee;
import com.example.demo.client.model.InternalServerException;
import com.example.demo.client.model.NotAuthorizedException;
import com.example.demo.client.model.Payment;
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<DelayPenalty>(
          ...
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<DelayPenalty>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<List<Fee>>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<List<Fee>>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<List<Payment>>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<List<Payment>>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<Fee>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<Fee>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
