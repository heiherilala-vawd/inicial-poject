...
public class CrupdateEmployeePayment {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEmployeeId() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getEmployeeId()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getPaymentDescription() != null) {
      joiner.add(
          String.format(
              "%spayment_description%s=%s",
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getPaymentDescription()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getPaymentType() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getPaymentType()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
