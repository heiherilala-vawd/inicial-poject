...
public class Course {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(mainTeacher, id, code, name, credits, totalHours);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTotalHours() != null) {
      joiner.add(String.format("%stotal_hours%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTotalHours()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
