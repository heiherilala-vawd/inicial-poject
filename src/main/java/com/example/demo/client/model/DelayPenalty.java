...
public class DelayPenalty {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `interest_percent` to the URL query string
    if (getInterestPercent() != null) {
      joiner.add(String.format("%sinterest_percent%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getInterestPercent()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `interest_timerate` to the URL query string
    if (getInterestTimerate() != null) {
      joiner.add(String.format("%sinterest_timerate%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getInterestTimerate()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `grace_delay` to the URL query string
    if (getGraceDelay() != null) {
      joiner.add(String.format("%sgrace_delay%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getGraceDelay()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `applicability_delay_after_grace` to the URL query string
    if (getApplicabilityDelayAfterGrace() != null) {
      joiner.add(String.format("%sapplicability_delay_after_grace%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getApplicabilityDelayAfterGrace()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
