...
public class TravelEquipment {
  ...
  public int hashCode() {
    return Objects.hash(
        id, travelId, equipment, quantity, status, createdAt, updatedAt, createdBy, updatedBy,
        comment);
  }
    ...
    if (getCreatedBy() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getCreatedBy()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getUpdatedBy() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getUpdatedBy()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
