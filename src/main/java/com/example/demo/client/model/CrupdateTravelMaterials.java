...
public class CrupdateTravelMaterials {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTravelId() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getTravelId()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getQuantityReceived() != null) {
      joiner.add(
          String.format(
              "%squantity_received%s=%s",
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getQuantityReceived()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
