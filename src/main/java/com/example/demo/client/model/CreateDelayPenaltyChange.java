...
public class CreateDelayPenaltyChange {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getInterestPercent() != null) {
      joiner.add(
          String.format(
              "%sinterest_percent%s=%s",
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getInterestPercent()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getInterestTimerate() != null) {
      joiner.add(
          String.format(
              "%sinterest_timerate%s=%s",
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getInterestTimerate()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getGraceDelay() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getGraceDelay()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getApplicabilityDelayAfterGrace() != null) {
      joiner.add(
          String.format(
              "%sapplicability_delay_after_grace%s=%s",
              prefix,
              suffix,
              URLEncoder.encode(
                      String.valueOf(getApplicabilityDelayAfterGrace()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
