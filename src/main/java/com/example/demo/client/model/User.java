...
import com.example.demo.client.model.EnableStatus;
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBirthDate() != null) {
      joiner.add(String.format("%sbirth_date%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBirthDate()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getEntranceDatetime() != null) {
      joiner.add(String.format("%sentrance_datetime%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getEntranceDatetime()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
