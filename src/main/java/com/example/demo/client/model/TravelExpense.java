...
public class TravelExpense {
  ...
  public int hashCode() {
    return Objects.hash(
        id, expenseId, departureLocation, arrivalLocation, departureDate, arrivalDate);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getExpenseId() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getExpenseId()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getDepartureLocation() != null) {
      joiner.add(
          String.format(
              "%sdeparture_location%s=%s",
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getDepartureLocation()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getArrivalLocation() != null) {
      joiner.add(
          String.format(
              "%sarrival_location%s=%s",
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getArrivalLocation()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getDepartureDate() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getDepartureDate()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getArrivalDate() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getArrivalDate()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
