...
public class CrupdateIncomeMoney {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMonetaryId() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getMonetaryId()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getSourceOrganization() != null) {
      joiner.add(
          String.format(
              "%ssource_organization%s=%s",
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getSourceOrganization()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getInvoiceReference() != null) {
      joiner.add(
          String.format(
              "%sinvoice_reference%s=%s",
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getInvoiceReference()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
