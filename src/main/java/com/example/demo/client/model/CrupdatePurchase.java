    ...
    if (getSupplier() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getSupplier()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getEquipment() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getEquipment()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getMaterial() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getMaterial()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getQuantity() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getQuantity()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
    ...
    if (getIsEquipment() != null) {
      joiner.add(
          String.format(
              ...
              prefix,
              suffix,
              URLEncoder.encode(String.valueOf(getIsEquipment()), StandardCharsets.UTF_8)
                  .replaceAll("\\+", "%20")));
    }
